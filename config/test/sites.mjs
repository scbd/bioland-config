// demo bf bj cm cd ci gn gw mg ma tg ch my th ph sg id gy ps ug eg nl bt lb kw ne om 27
...
export default {
  ...
  //new
  vn: { chmGovernment: 'VNM', environment, locale, locales:[ 'ar', 'en', 'es', 'fr',  'ru', 'zh' ] }
}
...
//   ne  : { chmGovernment: 'NER', environment, urls: ['test-ne.chm-cbd.net'], locale, locales: ['en', 'fr'] },
//   om  : { chmGovernment: 'OMN', environment, urls: ['test-om.chm-cbd.net'], locale, locales: ['en', 'ar'] },
